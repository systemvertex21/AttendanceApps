...
public class EditStaffAttendAdapter2 extends RecyclerView.Adapter <EditStaffAttendAdapter2.EditStaffAttendViewHolder> {

    ArrayList<Attendance> attendances;
    Context c;

    public EditStaffAttendAdapter2(ArrayList<Attendance> attendances, Context c) {
    ...
    @NotNull
    @Override
    public EditStaffAttendAdapter2.EditStaffAttendViewHolder onCreateViewHolder(@NonNull @NotNull ViewGroup parent, int viewType) {
        return new EditStaffAttendAdapter2.EditStaffAttendViewHolder(LayoutInflater.from(c).inflate(R.layout.staff_attend, parent, false));
    }

    @Override
    public void onBindViewHolder(@NonNull @NotNull EditStaffAttendAdapter2.EditStaffAttendViewHolder holder, int position) {
